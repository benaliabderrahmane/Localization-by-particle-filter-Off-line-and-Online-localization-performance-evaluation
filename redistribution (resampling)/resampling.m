function [Particles,OldParticles,OldRobot,vecteurTconvergence] = resampling(Particles,Choice,Obstacles,OldRobot,OldParticles,Nmax,TimeDebut,iteration,vecteurTconvergence,SdX,SdY,SdTheta)
